...
class TestNewsComments:
    ...
    @allure.severity(Severity.NORMAL)
    def test_like_comment(self, create_delete_comment_with_token):
        """Test: Like a comment."""
        access_token, _ = create_delete_comment_with_token
        comment_id = 2864  #TODO Replace with a dinamic comment ID. Need a second test account.
    ...
    def test_get_comment_by_id(self, create_delete_comment_with_token):
        """Test: Get a comment by its ID."""
        access_token, comment_response = create_delete_comment_with_token
    ...
    def test_delete_comment_by_id(self, create_comment_with_token):
        ...
        access_token, comment_response = create_comment_with_token
        comment_id = comment_response["id"]
        comment_client = EcoNewsCommentClient(Config.BASE_GREEN_CITY_API_URL, access_token)
