...
class TestTagSelection:
    ...
    def test_four_tags_selection_blocked(self, eco_news_page: NewsPage):
        ...
        create_news_page: CreateNewsPage = eco_news_page.click_create_news()
        ...
        create_news_page.enter_source(NewsTestData.TEST_SOURCE)
    ...
    @pytest.mark.parametrize("language", ["en", "ua"])
    def test_tag_selection(self, eco_news_page: NewsPage, language: str):
        """
    ...
    def test_single_tag_selection(self, eco_news_page: NewsPage):
        ...
        news_card = eco_news_page.get_news_card_by_index(0)
    ...
    def test_three_tags_selection(self, eco_news_page: NewsPage):
