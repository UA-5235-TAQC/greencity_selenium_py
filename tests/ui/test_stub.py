...
def test_base_navigate(get_driver):
    ...
    assert page.get_current_url() == Config.BASE_UI_GREEN_CITY_URL, f"Expected URL to be {Config.BASE_UI_GREEN_CITY_URL} butgot {page.get_current_url()}"
