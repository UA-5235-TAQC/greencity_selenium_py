...
CREATE_NEWS_LANGUAGE_DATA = {
    Language.EN: {"expected_tags": EcoNewsTag.get_all_en(), "drop_zone": "Drop your image here or", "browse": "browse",
        ...
        "date": DateUtils.get_current_date_formatted(Language.EN), "cancel_text": "Cancel", "preview_text": "Preview",
    ...
    Language.UK: {"expected_tags": EcoNewsTag.get_all_ua(), "drop_zone": "Перетягніть зображення сюди або",
        ...
        "date": DateUtils.get_current_date_formatted(Language.UK), "cancel_text": "Вийти",
...
EDIT_NEWS_LANGUAGE_DATA = {Language.EN: {# ---------- Title ----------
    ...
    # ---------- Image ----------
    "image_error": "Upload only PNG or JPG. File size must be less than 10MB", "cancel_cropper": "Cancel",
    ...
    "content_counter_after_append": "Number of characters: 30", "content_length_after_append": 30,

    "content_counter_after_prepend": "Number of characters: 34", "content_length_after_prepend": 34,

    "content_counter_after_remove": "Number of characters: 26", "content_length_after_remove": 26,

    "content_counter_final": "Number of characters: 31", "content_length_final": 31,

    # ---------- Tags ----------
    "tags_config": {"get_all": EcoNewsTag.get_all_en, "get_selected": EcoNewsTag.get_en, },

    # ---------- Author / Date ----------
    "date_locale": "en_US.UTF-8", "date_format": "%b %d, %Y",

    # ---------- Publish, Preview, Cancel buttons ----------
    "cancel_button_text": "Cancel", "preview_button_text": "Preview", "edit_button_text": "Edit",
    ...
    "cancel_modal_yes_button": "Yes, cancel", "cancel_modal_continue_button": "Continue editing",
    ...
    Language.UK: {# ---------- Title ----------
        ...
        # ---------- Image ----------
        "image_error": "Завантажуйте лише PNG або JPEG. Розмір файлу не повинен перевищувати 10Mb",
        "cancel_cropper": "Скасувати", "submit_cropper": "Застосувати",
        ...
        "content_counter_after_prepend": "Кількість символів: 43", "content_length_after_prepend": 43,

        "content_counter_after_remove": "Кількість символів: 30", "content_length_after_remove": 30,

        "content_counter_final": "Кількість символів: 35", "content_length_final": 35,

        # ---------- Tags ----------
        "tags_config": {"get_all": EcoNewsTag.get_all_ua, "get_selected": EcoNewsTag.get_ua, },

        # ---------- Author / Date ----------
        "date_locale": "uk_UA.UTF-8", "date_format": "%b %d, %Y р.",

        # ---------- Publish, Preview, Cancel buttons ----------
        "cancel_button_text": "Вийти", "preview_button_text": "Переглянути", "edit_button_text": "Редагувати",
        ...
        "cancel_modal_yes_button": "Скасувати", "cancel_modal_continue_button": "Продовжити",
