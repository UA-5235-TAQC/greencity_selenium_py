...
- Issue / Task / TestCase: https://github.com/UA-5235-TAQC/greencity_selenium5235/issues/{id}
...
- Allure server: https://ua-5235-taqc.github.io/greencity_selenium_py/pr-{pr-id}
- CI artifact: https://github.com/UA-5235-TAQC/greencity_selenium_py/actions?query=branch%3A{branch-name}
